...
import { stakeholders } from "@/data/mock";
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-8 py-10 md:py-16 space-y-10">
      ...
      <SectionCard section="agent">
        <BookingForm section="agent" slots={AGENT_SLOTS} topics={AGENT_TOPICS} />
      ...
      <SectionCard section="rep">
        <BookingForm section="rep" slots={REP_SLOTS} topics={REP_TOPICS} />
